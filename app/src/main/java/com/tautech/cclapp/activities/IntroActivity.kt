...
class IntroActivity : AppIntro() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addSlide(AppIntroFragment.newInstance(
            title = "Bienvenido...",
            description = "Esta es la aplicacion para los conductores de CCL",
            backgroundDrawable = R.drawable.truck_driver2,
        ))
        addSlide(AppIntroFragment.newInstance(
            title = "...Maneja tus tareas",
            description = "Desde aca puedes gestionar todas las planificaciones que te fueron asignadas",
        ...
        addSlide(AppIntroFragment.newInstance(
            title = "Empecemos!",
            description = "Ahora debes iniciar sesion con tus credenciales de conductor para poder usar esta aplicacion",
